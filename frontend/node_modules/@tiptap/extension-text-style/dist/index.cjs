    ...
    return [
      {
        ...
        attributes: {
          backgroundColor: {
            ...
            parseHTML: (element) => {
              var _a;
              const value = (_a = (0, import_core2.getStyleProperty)(element, "background-color")) != null ? _a : element.style.backgroundColor;
    ...
    return [
      {
        ...
        attributes: {
          color: {
            ...
            parseHTML: (element) => {
              var _a;
              const value = (_a = (0, import_core3.getStyleProperty)(element, "color")) != null ? _a : element.style.color;
              return value == null ? void 0 : value.replace(/['"]+/g, "");
            },
            renderHTML: (attributes) => {
              if (!attributes.color) {
    ...
    return [
      {
        ...
        attributes: {
          fontFamily: {
            ...
            parseHTML: (element) => {
              var _a;
              return (_a = (0, import_core4.getStyleProperty)(element, "font-family")) != null ? _a : element.style.fontFamily;
            },
            renderHTML: (attributes) => {
    ...
    return [
      {
        ...
        attributes: {
          fontSize: {
            ...
            parseHTML: (element) => {
              var _a;
              return (_a = (0, import_core5.getStyleProperty)(element, "font-size")) != null ? _a : element.style.fontSize;
            },
            renderHTML: (attributes) => {
    ...
    return [
      {
        ...
        attributes: {
          lineHeight: {
            ...
            parseHTML: (element) => {
              var _a;
              return (_a = (0, import_core6.getStyleProperty)(element, "line-height")) != null ? _a : element.style.lineHeight;
            },
            renderHTML: (attributes) => {
