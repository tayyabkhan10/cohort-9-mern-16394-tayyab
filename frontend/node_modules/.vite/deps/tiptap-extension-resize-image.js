  ...
  addCommands() {
    return {
      ...
      addCaption: (caption = "") => ({ chain, state }) => {
        ...
        return chain().insertContentAt({ from, to: from + node.nodeSize }, figureNode.toJSON(), {
      ...
      removeCaption: () => ({ state, dispatch: dispatch2 }) => {
        ...
        if (dispatch2) {
          ...
          dispatch2(state.tr.replaceWith(found.pos, found.pos + found.node.nodeSize, imageNode));
        }
        return true;
      },
      /**
